...
$wp_customize->add_panel(
    ...
    array(
        'priority'        => 270,
        'title'           => esc_html__('Раздел: Контакты', 'onepress'),
        'description'     => '',
...
$wp_customize->add_control(
    'onepress_contact_whatsapp',
    array(
        'label'         => esc_html__('Whatsapp', 'onepress'),
        'section'         => 'onepress_contact_content',
        'description'   => '',
    )
);
...
$wp_customize->add_control(
    'onepress_contact_yamap',
    array(
        'label'         => esc_html__('Код yandex карты.', 'onepress'),
        'section'         => 'onepress_contact_content',
        'description'   => '',
    )
);
...
// Show yamap
$wp_customize->add_setting(
    'onepress_contact_yamap_disable',
    array(
        'sanitize_callback' => 'onepress_sanitize_checkbox',
        'default'           => '',
    )
...
$wp_customize->add_control(
    ...
    array(
        'type'        => 'checkbox',
        'label'       => esc_html__('Отключить Yandex карту.', 'onepress'),
        'section'     => 'onepress_contact_content',
        // 'description' => esc_html__('Check this box to hide contact form.', 'onepress'),
    )
);
