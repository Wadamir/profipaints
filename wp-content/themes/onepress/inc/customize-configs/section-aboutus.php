...
$wp_customize->add_panel(
    ...
    array(
        'priority'        => 150,
        'title'           => esc_html__('Раздел: О компании', 'onepress'),
        'description'     => '',
...
$wp_customize->add_section(
    'onepress_aboutus_settings',
    array(
        'priority'    => 3,
        'title'       => esc_html__('Section Settings', 'onepress'),
        'description' => '',
        'panel'       => 'onepress_aboutus',
    )
);

// Show Content
$wp_customize->add_setting(
    'onepress_aboutus_disable',
    array(
...
$wp_customize->add_setting(
    ...
    array(
        ...
        'default'           => esc_html__('aboutus', 'onepress'),
    )
);
$wp_customize->add_control(
    'onepress_aboutus_id',
...
$wp_customize->add_control(
    new Onepress_Customize_Repeatable_Control(
        ...
        array(
            ...
            'description'   => '',
            'section'       => 'onepress_aboutus_content',
            ...
            'limited_msg'     => wp_kses_post(__('Upgrade to <a target="_blank" href="https://www.famethemes.com/plugins/onepress-plus/?utm_source=theme_customizer&utm_medium=text_link&utm_campaign=onepress_customizer#get-started">OnePress Plus</a> to be able to add more items and unlock other premium aboutus!', 'onepress')),
            'fields'    => array(
                'title'  => array(
