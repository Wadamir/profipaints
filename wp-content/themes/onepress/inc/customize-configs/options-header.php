...
$wp_customize->add_control(
	'onepress_whatsapp_phone',
	array(
		'label'       => esc_html__('Whatsapp phone number', 'onepress'),
		'section'     => 'onepress_header_settings',
		'description' => 'Номер телефона без пробелов и тире',
	)
);
$wp_customize->add_setting(
	'onepress_telegram_phone',
	array(
		'sanitize_callback' => 'sanitize_text_field',
		'default'           => '',
	)
...
$wp_customize->add_control(
	'onepress_telegram_phone',
	array(
		'label'       => esc_html__('Telegram phone number', 'onepress'),
		'section'     => 'onepress_header_settings',
		'description' => 'Номер телефона без пробелов и тире',
	)
);
