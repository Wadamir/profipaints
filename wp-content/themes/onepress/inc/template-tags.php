...
if (!function_exists('onepress_site_logo')) {
    function onepress_site_logo()
    {
        ...
        $mobile_logo = get_theme_mod('onepress_mobile_logo');
...
if (!function_exists('onepress_site_header')) {
    ...
    function onepress_site_header()
    {
        ...
        $header_main_phone = get_theme_mod('onepress_main_phone');
        $header_whatsapp_phone = get_theme_mod('onepress_whatsapp_phone');
        $header_telegram_phone = get_theme_mod('onepress_telegram_phone');
?>
            ...
            <div class="container">
                ...
                <div class="header-right-wrapper text-right">
                    ...
                    <div class="menu_wrapper">
                        ...
                        <a href="#0" id="nav-toggle" style="display:none;"><?php _e('Menu', 'onepress'); ?><span></span></a>
...
if (!function_exists('onepress_custom_inline_style')) {
    ...
    if (!function_exists('onepress_get_section_about2_data')) {
        /**
         * Get About2 data
         *
         * @return array
         */
        function onepress_get_section_about2_data()
        {
            $boxes = get_theme_mod('onepress_about2_boxes');
            if (is_string($boxes)) {
                $boxes = json_decode($boxes, true);
            }
            $page_ids = array();
    ...
    if (!function_exists('onepress_get_about_data')) {
        /**
         * Get about data
         *
         * @since 1.1.4
         * @return array
         */
        function onepress_get_about_data()
        {
            $array = get_theme_mod('onepress_about_boxes');
            if (is_string($array)) {
                $array = json_decode($array, true);
            }
            if (!empty($array) && is_array($array)) {
    ...
    if (!function_exists('onepress_get_about2_data')) {
         ...
         * @return array
         */
        function onepress_get_about2_data()
        {
            $array = get_theme_mod('onepress_about2_boxes');
            if (is_string($array)) {
                $array = json_decode($array, true);
            }
            if (!empty($array) && is_array($array)) {
    ...
    if (!function_exists('onepress_subscribe_form')) {
        ...
        ?>
            <div class="footer-subscribe">
                ...
                <form novalidate="" target="_blank" class="" name="mc-embedded-subscribe-form" id="mc-embedded-subscribe-form" method="post" action="<?php if ($onepress_newsletter_mailchimp != '') {
