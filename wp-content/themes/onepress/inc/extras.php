...
?>
                    <div class="video-section" data-fallback="<?php echo get_theme_mod('onepress_hero_mobile_img') ? 'true' : 'false'; ?>" data-mp4="<?php echo esc_url($video_url); ?>" data-webm="<?php echo esc_url($video_webm_url); ?>" data-ogv="<?php echo esc_url($video_ogv_url); ?>" data-bg="<?php echo esc_attr($image); ?>">
                    <?php
                }
                break;
...
function onepress_section_class($class, $section_id)
{
    if ($section_id == 'hero') {
        $class .= ' section-hero';
    }
