...
$meta_class = get_theme_mod('onepress_counter_meta') == 1 ? 'onepress-meta' : '';
$section_classes = esc_attr(apply_filters('onepress_section_class', "section-counter section-padding onepage-section {$meta_class}", 'counter'));
...
?>
    <?php if ($disable != '1') : ?>
        <?php if (!onepress_is_selective_refresh()) { ?>
            <section id="<?php echo ($id !== '') ? esc_attr($id) : 'counter'; ?>" <?php do_action('onepress_section_atts', 'counter'); ?> class="<?php echo $section_classes; ?>">
            <?php } ?>
