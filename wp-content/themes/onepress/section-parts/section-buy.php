...
$layout = intval(get_theme_mod('onepress_buy_layout', 12));
// $layout_col = 12 / $layout;
if (onepress_is_selective_refresh()) {
    $disable = false;
}
// $data  = onepress_get_buy_data();
if (!$disable) {
    $desc = get_theme_mod('onepress_buy_desc');
?>
    <?php if (!onepress_is_selective_refresh()) { ?>
        <section id="<?php echo ($id !== '') ? esc_attr($id) : 'buy'; ?>" <?php do_action('onepress_section_atts', 'buy'); ?> class="<?php echo $section_classes; ?>">
        <?php } ?>
        <?php do_action('onepress_section_before_inner', 'buy'); ?>
            ...
            <div class="section-content">
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 d-flex align-items-stretch">
                        <div class="buy-item w-100 h-100">
                            <div class="buy-bg w-100 h-100" <?php echo $background_image1 ?>>
                    ...
                    <div class="col-12 col-md-4 d-flex align-items-stretch">
                        <div class="buy-item w-100 h-100">
                            <div class="buy-bg buy-bg-half w-100 h-50" <?php echo $background_image2 ?>>
                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.5" y="0.5" width="29" height="29" rx="14.5" stroke="white" />
                                    <path d="M20.0001 9L10.4168 8.58333L10.4755 9.93458L17.7447 10.2554L8.50012 19.5L9.50012 20.5L18.7447 11.2554L19.0655 18.5246L20.4168 18.5833L20.0001 9Z" fill="white" />
                                </svg>
                            </div>
                            <div class="buy-bg buy-bg-half w-100 h-50" <?php echo $background_image3 ?>>
                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="0.5" y="0.5" width="29" height="29" rx="14.5" stroke="white" />
                                    <path d="M20.0001 9L10.4168 8.58333L10.4755 9.93458L17.7447 10.2554L8.50012 19.5L9.50012 20.5L18.7447 11.2554L19.0655 18.5246L20.4168 18.5833L20.0001 9Z" fill="white" />
                                </svg>
        ...
        <?php do_action('onepress_section_after_inner', 'buy'); ?>
        <?php if (!onepress_is_selective_refresh()) { ?>
        </section>
    <?php } ?>
<?php } ?>