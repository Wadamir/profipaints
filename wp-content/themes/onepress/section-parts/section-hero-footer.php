...
$onepress_hcl1_modaltitle  = get_theme_mod('onepress_hcl1_modaltitle');
$onepress_hcl1_modaltext = get_theme_mod('onepress_hcl1_modaltext');
        ...
        <div class="modal-dialog modal-dialog-centered modal-wide">
            <div class="modal-content modal-content-high">
                <div class="modal-header px-40 py-30">
                    <h3><?php echo esc_html($onepress_hcl1_modaltitle); ?></h3>
                ...
                <div class="modal-body px-40 py-30">
                    <p><?php echo $onepress_hcl1_modaltext; ?></p>
