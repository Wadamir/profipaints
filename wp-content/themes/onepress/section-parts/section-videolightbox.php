...
$meta_class = get_theme_mod('onepress_videolightbox_meta') == 1 ? 'onepress-meta' : '';
$section_classes = esc_attr(apply_filters('onepress_section_class', "section-videolightbox section-padding onepage-section {$meta_class}", 'videolightbox'));
...
?>
        <section id="<?php echo ($id !== '') ? esc_attr($id) : 'videolightbox'; ?>" <?php do_action('onepress_section_atts', 'videolightbox'); ?> class="<?php echo $section_classes; ?>">
        <?php } ?>
