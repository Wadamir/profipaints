...
$meta_class = get_theme_mod('onepress_team_meta') == 1 ? 'onepress-meta' : '';
$section_classes = esc_attr(apply_filters('onepress_section_class', "section-team section-padding onepage-section {$meta_class}", 'team'));
...
?>
    <?php if (!$disable) : ?>
        <?php if (!onepress_is_selective_refresh()) { ?>
            <section id="<?php echo ($id !== '') ? esc_attr($id) : 'team'; ?>" <?php do_action('onepress_section_atts', 'team'); ?> class="<?php echo $section_classes; ?>">
            <?php } ?>
