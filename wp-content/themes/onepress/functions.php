...
function onepress_scripts()
{
    ...
    if (!$is_shop) {
        ...
        wp_enqueue_script('onepress-gallery-carousel', get_template_directory_uri() . '/assets/js/owl.carousel.min.js', array('jquery'), $version, true);
...
if (!function_exists('onepress_fonts_url')) :
    ...
    function onepress_fonts_url()
    {
		...
		*/
        $open_sans = _x('off', 'Open Sans font: on or off', 'onepress');
		...
		* into your own language.
		*/
        $raleway = _x('off', 'Raleway font: on or off', 'onepress');
		...
		* into your own language.
		*/
        $roboto_condensed = _x('off', 'Roboto Condensed font: on or off', 'onepress');
		...
		* into your own language.
		*/
        $oswald = _x('off', 'Oswald font: on or off', 'onepress');
		...
		* into your own language.
		*/
        $playfair = _x('off', 'Playfair Display font: on or off', 'onepress');
		...
		* into your own language.
		*/
        $montserrat = _x('on', 'Montserrat font: on or off', 'onepress');
